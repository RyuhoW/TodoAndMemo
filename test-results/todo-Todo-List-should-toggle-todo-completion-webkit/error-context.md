...
- Location: C:\Users\ryuho\SynologyDrive\Projects\react-demo\e2e\todo.spec.ts:17:7
...
Call log:
  - waiting for locator('.todo-item:has-text("完了するタスク") .checkbox')

    at C:\Users\ryuho\SynologyDrive\Projects\react-demo\e2e\todo.spec.ts:23:16
```
