...
- Location: C:\Users\ryuho\SynologyDrive\Projects\TodoAndMemo\e2e\todo.spec.ts:36:7
...
Call log:
  - waiting for locator('input[placeholder="新しいTodoを入力"]') to be visible
    ...
    at C:\Users\ryuho\SynologyDrive\Projects\TodoAndMemo\e2e\todo.spec.ts:38:16
```
