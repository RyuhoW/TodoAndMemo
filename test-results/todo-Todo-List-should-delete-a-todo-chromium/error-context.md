...
- Location: C:\Users\ryuho\SynologyDrive\Projects\react-demo\e2e\todo.spec.ts:31:7
...
Call log:
  - waiting for locator('.todo-item:has-text("削除するタスク") .delete-button')

    at C:\Users\ryuho\SynologyDrive\Projects\react-demo\e2e\todo.spec.ts:40:16
```
