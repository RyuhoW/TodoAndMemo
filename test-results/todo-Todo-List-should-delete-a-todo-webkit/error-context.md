...
- Name: Todo List >> should delete a todo
- Location: C:\Users\ryuho\SynologyDrive\Projects\react-demo\e2e\todo.spec.ts:29:7
...
Locator: locator('li:has-text("削除するタスク")')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('li:has-text("削除するタスク")')

    at C:\Users\ryuho\SynologyDrive\Projects\react-demo\e2e\todo.spec.ts:35:58
```
